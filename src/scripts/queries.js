...
const pull_queryMonitores = `SELECT resumo as name, CONCAT(ecol1, '/@!/', sqlexpr, '/@!/', ecol3) as code, emoistamp as stamp, '/monitores/' as folder, 'ecol1/@!/,sqlexpr/@!/ecol3' as type, '.vb' as extension FROM emoi` //ecol1 sqlexpr ecol3
module.exports = {
    pull_queryjsUser,
